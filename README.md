...
If you wish to configure the Windows Victim manually or something goes wrong with the script, you can follow this section. In the first iteration of the .ps1 script there were some issues with the code and required manual configuration. These have been corrected since then.
